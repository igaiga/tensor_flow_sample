# coding: UTF-8
# python conv_cifar10_png.py --file ./data/data_batch_1.bin
# data フォルダにデータを置くこと
# http://www.cs.toronto.edu/~kriz/cifar.html の CIFAR-10 binary version (suitable for C programs)
# $ pip install image #=> for line 12
